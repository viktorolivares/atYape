                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="#">Mulfood</a></li>
                            <li class="breadcrumb-item active">Listado de Transacciones</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Yape! Mulfood</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
...
export default {
    ...
    data() {
        return {
            apiUrl: "/api/transactions/list?description=mulfood",
            filter: {
                description: '',
                state: '',
                person: '',
    ...
    mounted() {
        ...
        window.Echo.channel('transactions').listen('NewTransactionSaved', (e) => {
            ...
            if (e.transaction.description === 'mulfood') {
